...
struct msm_sensor_power_setting_array32 {
	...
	compat_uptr_t power_setting_0;
	compat_uptr_t power_setting_a;
	compat_uptr_t power_setting_b;
	uint16_t size;
	uint16_t size_0;
	uint16_t size_a;
	uint16_t size_b;
	compat_uptr_t power_down_setting;
	compat_uptr_t power_down_setting_0;
	compat_uptr_t power_down_setting_a;
	compat_uptr_t power_down_setting_b;
	uint16_t size_down;
	uint16_t size_down_0;
	uint16_t size_down_a;
	uint16_t size_down_b;
};
#else //QCT
struct msm_sensor_power_setting_array32 {
...
/* LGE_CHANGE_E, Enable touch AE in soc sensor , 2013-11-12, dongsu.bag@lge.com */
	...
	CFG_SET_STREAM_TYPE,
	CFG_SET_INIT_SETTING_QR_CODE,  // LGE_CHANGE
	CFG_SET_START_STREAM_QR_CODE, // LGE_CHANGE
	CFG_SET_RESOLUTION_QR_CODE,  // LGE_CHANGE
};
...
struct msm_camera_i2c_reg_setting32 {
	...
	//uint16_t *value;	/* LGE_Change, Add SOC exif information for Non ZSL mode, 27-04-2015, ranjith.k@lge.com */
};
