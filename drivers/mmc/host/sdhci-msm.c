...
#if defined(CONFIG_MACH_MSM8909_M1_SPR_US) || defined(CONFIG_MACH_MSM8909_M1_TMO_US) || defined(CONFIG_MACH_MSM8909_M1_MPCS_US) || defined(CONFIG_MACH_MSM8909_M1_TRF_US) || defined(CONFIG_MACH_MSM8909_M1_TRF_US_VZW)
...
static int sdhci_msm_probe(struct platform_device *pdev)
{
	...
	unsigned long flags;
#if defined(CONFIG_LGE_SDCARD_LDO_GPIO_ENABLE)
	int rc;
#if defined(CONFIG_MACH_MSM8909_M1_SPR_US) || defined(CONFIG_MACH_MSM8909_M1_TMO_US) || defined(CONFIG_MACH_MSM8909_M1_MPCS_US) || defined(CONFIG_MACH_MSM8909_M1_TRF_US) || defined(CONFIG_MACH_MSM8909_M1_TRF_US_VZW)
	enum hw_rev_type hw_rev = lge_get_board_revno();
#if defined(CONFIG_MACH_MSM8909_M1_SPR_US)
	if(hw_rev <= HW_REV_0) {
#elif defined(CONFIG_MACH_MSM8909_M1_TMO_US) || defined(CONFIG_MACH_MSM8909_M1_MPCS_US) || defined(CONFIG_MACH_MSM8909_M1_TRF_US) || defined(CONFIG_MACH_MSM8909_M1_TRF_US_VZW) 
	if(hw_rev <= HW_REV_A) {
#endif
#endif
		if(gpio_is_valid(CONFIG_LGE_SDCARD_LDO_GPIO_NUM)) {
			rc = gpio_request(CONFIG_LGE_SDCARD_LDO_GPIO_NUM, "sdc_ldo_en");
			mdelay(5);

			if(rc) {
				pr_err("sdc_ldo_en gpio failed %d\n", rc);
			} else {
				rc = gpio_direction_output(CONFIG_LGE_SDCARD_LDO_GPIO_NUM, 1);
				mdelay(5);
				gpio_set_value(CONFIG_LGE_SDCARD_LDO_GPIO_NUM, 1);
			}
		}
#if defined(CONFIG_MACH_MSM8909_M1_SPR_US) || defined(CONFIG_MACH_MSM8909_M1_TMO_US) || defined(CONFIG_MACH_MSM8909_M1_MPCS_US) || defined(CONFIG_MACH_MSM8909_M1_TRF_US) || defined(CONFIG_MACH_MSM8909_M1_TRF_US_VZW)
	}
