...
#ifdef CONFIG_LGE_PM_FLOATED_CHARGER
			pr_info("cancel counter for checking dcd timeout\n");
...
/* TODO : dock check code will be removed in usb source.*/
#else
				  ...
				  union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_FLOATED_CHARGER:
		val->intval = motg->is_floated_charger;
		break;
#endif
	default:
		return -EINVAL;
