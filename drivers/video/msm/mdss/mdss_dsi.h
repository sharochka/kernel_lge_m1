...
enum dsi_panel_bl_ctrl {
	...
	BL_WLED,
	BL_DCS_CMD,
#if defined(CONFIG_BACKLIGHT_LM3530) || defined(CONFIG_BACKLIGHT_RT4832) || defined(CONFIG_BACKLIGHT_RT8542)
	BL_OTHERS,
#endif
	UNKNOWN_CTRL,
};
...
#if defined( CONFIG_LGD_DB7400_HD_5INCH_VIDEO_PANEL )
