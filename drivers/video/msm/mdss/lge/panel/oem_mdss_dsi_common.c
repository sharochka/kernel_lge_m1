...
static struct panel_list supp_panels[] = {
	...
	{"LGD DB7400 HD video mode dsi panel", LGD_DB7400_HD_VIDEO_PANEL},
...
int pre_mdss_dsi_panel_power_ctrl(struct mdss_panel_data *pdata, int enable)
{
	...
	case LGD_SSD2068_FWVGA_VIDEO_PANEL:
		...
		break;
#elif defined(CONFIG_LGD_DB7400_HD_VIDEO_PANEL)
	case LGD_DB7400_HD_VIDEO_PANEL:
		rc = lgd_db7400_hd_video_pre_mdss_dsi_panel_power_ctrl(pdata, enable);
		break;
#elif defined (CONFIG_TCL_ILI9806E_FWVGA_VIDEO_PANEL)
...
#elif defined(CONFIG_LGD_DB7400_HD_VIDEO_PANEL)
	case LGD_DB7400_HD_VIDEO_PANEL:
		rc = lgd_db7400_hd_video_post_mdss_dsi_panel_power_ctrl(pdata, enable);
		break;
#elif defined (CONFIG_TCL_ILI9806E_FWVGA_VIDEO_PANEL)
	case TCL_ILI9806E_FWVGA_VIDEO_PANEL:
...
#elif defined(CONFIG_LGD_DB7400_HD_VIDEO_PANEL)
	case LGD_DB7400_HD_VIDEO_PANEL:
		rc = lgd_db7400_hd_video_msm_mdss_enable_vreg(ctrl_pdata, enable);
		break;
#elif defined (CONFIG_TCL_ILI9806E_FWVGA_VIDEO_PANEL)
	case TCL_ILI9806E_FWVGA_VIDEO_PANEL:
		break;
...
#elif defined(CONFIG_LGD_DB7400_HD_VIDEO_PANEL)
	case LGD_DB7400_HD_VIDEO_PANEL:
		rc = lgd_db7400_hd_video_mdss_dsi_panel_reset(pdata, enable);
		break;
#elif defined (CONFIG_TCL_ILI9806E_FWVGA_VIDEO_PANEL)
	case TCL_ILI9806E_FWVGA_VIDEO_PANEL:
...
#elif defined(CONFIG_LGD_DB7400_HD_VIDEO_PANEL)
	case LGD_DB7400_HD_VIDEO_PANEL:
		rc = lgd_db7400_hd_video_mdss_dsi_request_gpios(ctrl_pdata);
		break;
#elif defined (CONFIG_TCL_ILI9806E_FWVGA_VIDEO_PANEL)
	case TCL_ILI9806E_FWVGA_VIDEO_PANEL:
...
#elif defined(CONFIG_LGD_DB7400_HD_VIDEO_PANEL)
	case LGD_DB7400_HD_VIDEO_PANEL:
		rc = lgd_db7400_hd_video_mdss_panel_parse_dts(np, ctrl_pdata);
		break;
#elif defined (CONFIG_TCL_ILI9806E_FWVGA_VIDEO_PANEL)
	case TCL_ILI9806E_FWVGA_VIDEO_PANEL:
...
#elif defined(CONFIG_LGD_DB7400_HD_VIDEO_PANEL)
	case LGD_DB7400_HD_VIDEO_PANEL:
		rc = lgd_db7400_hd_video_panel_device_create(node, ctrl_pdata);
		break;
#elif defined (CONFIG_TCL_ILI9806E_FWVGA_VIDEO_PANEL)
	case TCL_ILI9806E_FWVGA_VIDEO_PANEL:
...
#elif defined(CONFIG_LGD_DB7400_HD_VIDEO_PANEL)
	case LGD_DB7400_HD_VIDEO_PANEL:
		rc = lgd_db7400_hd_video_dsi_panel_device_register(pan_node, ctrl_pdata);
		break;
#elif defined (CONFIG_TCL_ILI9806E_FWVGA_VIDEO_PANEL)
	case TCL_ILI9806E_FWVGA_VIDEO_PANEL:
