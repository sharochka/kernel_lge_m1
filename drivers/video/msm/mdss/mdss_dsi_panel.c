...
#if defined(CONFIG_BACKLIGHT_RT4832)
extern void rt4832_lcd_backlight_set_level(int level);
#endif
							...
							u32 bl_level)
{
	...
	case BL_DCS_CMD:
		...
		break;
#if defined(CONFIG_BACKLIGHT_LM3530) || defined(CONFIG_BACKLIGHT_RT4832) || defined(CONFIG_BACKLIGHT_RT8542) || defined(CONFIG_BACKLIGHT_RT9393) || defined(CONFIG_BACKLIGHT_SM5306)
	case BL_OTHERS:
#if defined(CONFIG_BACKLIGHT_LM3530)
		lm3530_lcd_backlight_set_level(bl_level);
		break;
#elif defined(CONFIG_BACKLIGHT_RT4832)
		rt4832_lcd_backlight_set_level(bl_level);
		break;
...
#ifdef CONFIG_LGD_DB7400_HD_5INCH_VIDEO_PANEL
		if(oem_shutdown_pending)
			rt4832_set_dsv_addressC();
#endif
			...
			struct mdss_dsi_ctrl_pdata *ctrl_pdata)
{
	...
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->post_panel_on_cmds,
		"qcom,mdss-dsi-post-panel-on-command", "qcom,mdss-dsi-post-panel-on-command-state");
#else
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->post_panel_on_cmds,
