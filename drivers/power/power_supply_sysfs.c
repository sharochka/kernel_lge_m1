...
static ssize_t power_supply_show_property(struct device *dev,
	...
	static char *type_text[] = {
		...
		"Fuel-Gauge",
#endif /* CONFIG_LGE_PM_BATTERY_EXTERNAL_FUELGAUGE */
...
#ifdef CONFIG_LGE_PM_CHARGING_RT5058_CHARGER
	else if (off == POWER_SUPPLY_PROP_CHARGE_OTG_CONTROL)
...
static struct device_attribute power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(floated_charger),
#endif
...
#ifdef CONFIG_LGE_PM_CHARGING_RT5058_CHARGER
	POWER_SUPPLY_ATTR(batt_present),
	POWER_SUPPLY_ATTR(charger_eoc),
	POWER_SUPPLY_ATTR(otg_control),
#endif /* CONFIG_LGE_PM_CHARGING_RT5058_CHARGER */
#ifdef CONFIG_LGE_PM_FUELGAUGE_RT5058
	POWER_SUPPLY_ATTR(capacity_raw),
	POWER_SUPPLY_ATTR(temp_raw),
#endif
